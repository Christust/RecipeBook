...
namespace RecipeBook.Controllers
{
    ...
    public class RecipesController : ControllerBase
    {
        ...
        {
            return await _context.Recipes.Include(r=>r.Chef).ToListAsync();
        }
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Recipe>> PostRecipe(CreateRecipe createRecipe)
        {
            var chef = _context.Chefs.FirstOrDefault(ch=>ch.Id == createRecipe.ChefId);
            if (chef == null)
            {
                return NotFound(createRecipe);
            }
